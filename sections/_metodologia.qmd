...
![Datos utilizados para las pruebas](images/List of Names.png){width=40%}
...
![Ejecución del Algoritmo Fuerza Bruta](images/Ejecuta Algoritmo fuerza bruta.png){width=40%}

La ejecución del algoritmo de fuerza bruta de búsqueda de nombres muestra una ejecución lineal.
